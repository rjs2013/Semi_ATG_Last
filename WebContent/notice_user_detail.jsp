...
<!-- notice_user_detail 관련 -->
<script type="text/javascript" src="resources/js/Template.js"></script>
<link rel="stylesheet" href="resources/css/Template.css">
<link rel="stylesheet" href="resources/css/notice_user_detail.css">
...
%>
   ...
   <section class="secssion">
	<div class="container my-1" id="box">
		...
		<table class="table table-bordered" id="box_tb" style='width:100%;'>
			<col width = "20%" />
			<col width = "80%" />
			...
			<tr>
				...
				<td readonly="readonly" name="rv_content" style="resize:none; height:280px;"><%=dto.getNt_content() %></td>
			</tr>
			<tr>
				<td colspan="2" align="right">
					<input class="btn btn-secondary btn-sm" type="button" value="목록" onclick="location.href='NoticeController.do?command=notice_list&nt_no=1'" />
				</td>
			</tr>
		</table>
		</div>
