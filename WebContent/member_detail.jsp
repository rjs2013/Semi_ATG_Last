...
<link rel="stylesheet" href="resources/css/member_detail.css">
...
%>
   ...
   <section class="secssion">
		...
		<table class="table table-bordered" id="box_tb">
			<col width = "10%" />
			<col width = "40%" />
			<tr>
			...
			<tr>
				<td colspan="2" align="right">
					<input class="btn btn-secondary btn-sm" type="button" value="수정" onclick="location.href='member_update.jsp?mb_no=<%=dto.getMb_no() %>'" />
					<input class="btn btn-secondary btn-sm mr-1" type="button" value="목록" onclick="location.href='adminpage.jsp'" />
				</td>
			</tr>
		</table>
		</div>
