		...
		<col width="500">
			...
			<tr>
				...
				<td>
					...
					<input class="btn btn-secondary btn-sm" type="button" value="아이디 중복 확인" placeholder="아이디를 입력" onclick="idCheck();">
				</td>
			</tr>
			<tr>
...
%>	
			...
			<tr>
				<th class="text-center">이메일</th>
					...
					<button class="btn btn-secondary btn-sm" id="echeck" onclick="emailCheck();">이메일중복</button>&nbsp;<button class="btn btn-secondary btn-sm" id="checkEmail" value="" onclick="emailconfirm('<%=getRandom()%>')">인증번호전송</button>
					</td>
			...
			<tr>
				...
				<td>
					...
					<input class="btn btn-secondary btn-sm" type="button" onclick="checkNum('<%= random %>')" value="인증확인" />
				</td>
			</tr>	
