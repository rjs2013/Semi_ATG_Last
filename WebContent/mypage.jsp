...
<!-- 두개는 메뉴바 css -->
<link rel="stylesheet" href="resources/css/main_mypage.css">
  ...
  <section class="secssion">   		
	   	<div class="propile_box">
	   		<div class="propile_img_box">
	   			<img alt="" src="resources/img/<%=LDto.getMb_photo()%>" id="propile_img">
	   		</div>
	   		<p class="propile_id"><%=LDto.getMb_id()%> 님</p>
	   		<input type="button" class="propile_update" value="개인정보수정" onclick="location.href='member_pw_check.jsp'">
	   	</div> 
	   	<div id="inbody">
	   		<h6>인바디 그래프</h6>   
 			<div id="curve_chart"></div>  
 			<!--  <button class="inbody_update" onclick="location.href='InbodyController.do?command=inbody_insert'">인바디 입력</button>-->
 			<input type="button" value="인바디" class="inbody_button" onclick="location.href='InbodyController.do?command=inbody_insert'">
 		</div>
  
   
   <div id="box">
   		<table id="calendar">
   		<span class="q"><%=year %>년</span>
		<span class="q"><%=month %>월</span>
		<pre>
		<caption>
