...
%>
   ...
   <section class="secssion">
   	<div id="box">
   		<form action="InbodyController.do" method="post">
		<input type="hidden" name="command" value="inbody_insertres"/>
		...
		<table id="box_tb" border="1">
			...
			<tr>
				<td colspan="2" align="right">
					<input type="submit" value="인바디 등록" />
					<input type="button" value="돌아가기" onclick="mypage.jsp" />
				</td>
			</tr>
		</table>
	</form>
